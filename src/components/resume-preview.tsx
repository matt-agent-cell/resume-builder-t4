...
export default function ResumePreview({ onDesignClick }: { onDesignClick?: () => void }) {
  ...
  return (
    <div className="h-full flex flex-col bg-stone-100 relative group/preview">
      ...
      {activeTab === "resume" && (
      <div className="resume-paper max-w-[8.5in] mx-auto relative" style={{ fontFamily, color: textColor, fontSize: `${basePx}px`, lineHeight, minHeight: "11in", paddingLeft: marginsX, paddingRight: marginsX, paddingTop: marginsY, paddingBottom: marginsY }}>
        {/* Header */}
